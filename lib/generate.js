...
- Carte-info : bloc structuré avec date/heure/lieu affichés clairement et lisiblement (grande taille, fort contraste), photo ou motif décoratif en arrière-plan discret — OBLIGATOIRE pour les invitations : la lisibilité des informations pratiques prime toujours sur l'effet visuel
...
pratiques (date, heure, lieu, tenue) et non une émotion à exprimer. Utilise
impérativement le traitement "Carte-info", assure-toi que chaque information
reste lisible au moins 2 secondes à l'écran, et ne sacrifie jamais la clarté
du texte à l'esthétique — une invitation qu'on doit deviner ou re-regarder
pour lire l'heure a échoué à sa mission.
